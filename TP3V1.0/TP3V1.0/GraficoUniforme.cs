...
namespace TP3V1._0
{
    public partial class GraficoUniforme : Form
    {
        public GraficoUniforme()
        {
            InitializeComponent();
        }

        private void ch_uniforme_Click(object sender, EventArgs e)
        {
        ...
        private void btn_chi_Click(object sender, EventArgs e)
        {
            ...
            double suma = 0;
            int cantidadIntervalos = dgv_graficoUniforme.RowCount - 1;
            int gradosLibertad = cantidadIntervalos - 1;//para uniforme
            for(int i = 0; i < dgv_graficoUniforme.RowCount-1; i++)
            {
               String a= dgv_graficoUniforme.Rows[i].Cells[4].Value.ToString();
        ...
        private void GraficoUniforme_Load(object sender, EventArgs e)
        {

        }

        private void btn_salirGrafUnif_Click(object sender, EventArgs e)
        {
            this.Close();
            dgv_graficoUniforme.Rows.Clear();
        }
    }
}
